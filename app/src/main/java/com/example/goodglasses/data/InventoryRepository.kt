...
//    private val expiryUrl = "https://gillian-unhesitative-jestine.ngrok-free.dev/api/v1/detect"
    private var expiryHost = "192.168.0.186"
    private var expiryPort = "8881"
    private val expiryUrl: String
        get() = "http://$expiryHost:$expiryPort/api/v1/detect"
    ...
    fun getExpiryServerAddress(): String = "$expiryHost:$expiryPort"
